...
- `deliverables/assets/course-detail.png`：课程详情页
- `deliverables/assets/lab.png`：AI 工具台
- `deliverables/assets/quiz.png`：复习题系统
- `deliverables/assets/rag-source.png`：带来源引用的问答结果
